...
const COLORS = {
  ...
  greenLight: "var(--color-purple)",
  yellow: "var(--color-light-purple)",
  ...
  if (variant === "hero") {
    return (
      ...
      >
        ...
        <div className="absolute -right-16 top-10 h-40 w-40 rounded-full bg-[var(--color-light-purple)]/20 blur-3xl transition-all duration-700 group-hover:scale-125" />
        ...
        <div className="absolute bottom-4 left-4 right-4 sm:bottom-7 sm:left-7 sm:right-7">
          ...
          >
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[var(--color-light-purple)] text-white shadow-[0_0_30px_rgba(255,186,0,0.25)] sm:h-12 sm:w-12 sm:rounded-2xl">
                {ServiceIcon && (
                  <ServiceIcon
                    size={22}
                    strokeWidth={1.8}
              ...
              <div className="min-w-0">
                <p className="text-[8px] font-black uppercase tracking-[0.15em] text-[var(--color-light-purple)] sm:text-[9px]">
                  Digital Service
                </p>
        ...
        <div className="absolute right-6 top-1/2 hidden -translate-y-1/2 sm:block">
          <div className="flex gap-2">
            <span className="h-2 w-2 animate-pulse rounded-full bg-[var(--color-light-purple)]" />
            <span className="h-2 w-2 animate-pulse rounded-full bg-[var(--color-light-purple)]/60 [animation-delay:200ms]" />
            <span className="h-2 w-2 animate-pulse rounded-full bg-[var(--color-light-purple)]/30 [animation-delay:400ms]" />
          </div>
        </div>
      </div>
    );
      ...
      >
        ...
        <div className="absolute bottom-5 left-5 right-5 sm:bottom-7 sm:left-7 sm:right-7">
          <div className="max-w-md">
            <div className="mb-3 flex h-11 w-11 items-center justify-center rounded-xl bg-[var(--color-light-purple)] text-white shadow-[0_0_35px_rgba(255,186,0,0.25)] transition-transform duration-500 group-hover:scale-110 sm:h-14 sm:w-14 sm:rounded-2xl">
              {ServiceIcon && (
                <ServiceIcon
                  size={24}
                  strokeWidth={1.8}
            ...
            <p className="text-[9px] font-black uppercase tracking-[0.18em] text-[var(--color-light-purple)] sm:text-[10px]">
              Why It Matters
            </p>
        ...
        <div className="absolute bottom-0 left-0 h-1 w-0 bg-[var(--color-light-purple)] transition-all duration-700 group-hover:w-full" />
      </div>
    );
  }
...
function FeatureCard({ feature }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative flex h-12 w-12 items-center justify-center rounded-xl bg-[var(--color-light-purple)] text-white transition-all duration-300 group-hover:rotate-3 group-hover:scale-105 sm:h-14 sm:w-14 sm:rounded-2xl">
        <FeatureIcon
          size={22}
          strokeWidth={1.8}
        />
      ...
      <h3 className="relative mt-6 text-xl font-black tracking-[-0.035em] text-[var(--color-deep)]  sm:mt-7 sm:text-2xl">
        {feature.title}
      </h3>

      <p className="relative mt-4 text-sm leading-7 text-[var(--color-deep)]/60 sm:text-base">
        {feature.description}
      </p>
    </article>
  );
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="pointer-events-none absolute -right-32 -top-32 h-72 w-72 rounded-full bg-[var(--color-purple)]/10 blur-3xl dark:bg-[var(--color-purple)]/10" />
      ...
      <section className="bg-[var(--color-purple)] px-4 py-6 text-white sm:px-5 sm:py-7">
  ...
  <div className="pointer-events-none absolute inset-0 overflow-hidden">
    ...
    <div
      className="
        ...
        w-72
        rounded-full
        bg-[var(--color-light-purple)]/[0.05]
        blur-[100px]
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-2 sm:gap-4">
              {service.problemPoints.map((point) => (
                ...
                >
                  ...
                  <p className="min-w-0 text-sm font-semibold leading-6 text-[var(--color-deep)]/65">
                    {point}
                  </p>
                </div>
              ))}
            ...
            {service.deliverables.map((item) => (
              <div
                ...
                className="
                  ...
                  hover:-translate-y-1
                  hover:border-[var(--color-light-purple)]/50
