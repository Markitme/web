...
return ( <main className="bg-white text-black dark:bg-[#0a0a0a] dark:text-white"> <section className="border-b border-black/10 px-5 py-24 dark:border-white/10 sm:py-32"> <div className="container-custom"> <p className="text-sm font-bold uppercase tracking-[0.2em] text-[var(--accent)] dark:text-[var(--accent-bright)]">
Insights </p>


      <h1 className="mt-5 text-5xl font-black tracking-[-0.05em] sm:text-7xl bg-gradient-to-r from-black via-[var(--accent)] to-[var(--accent-bright)] bg-clip-text text-transparent dark:from-white dark:via-[var(--accent-bright)] dark:to-[var(--accent)]">
      ...
      {posts.map((post) => (
        ...
        >
          ...
          <div className="mt-8 flex items-center justify-between">
            ...
            <Link
              href="#"
              className="flex items-center gap-2 text-sm font-bold transition hover:text-[var(--accent)] dark:hover:text-[var(--accent-bright)]"
            >
              Read article
              <ArrowRight size={17} />
            </Link>
